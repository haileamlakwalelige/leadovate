...
const Footer = () => {
  return (
    <div className="flex justify-center items-center px-2 sm:px-4 md:px-8 lg:px-16 bg-[#DCDCDC] min-h-[50vh]">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-center items-center gap-10 lg:gap-20">
        <div>
          ...
          <p>
            Leadovate in mentorship embodies the idea of mentors taking the lead
            in empowering their mentees to innovate, grow, and achieve their
            goals
          </p>
        </div>
        <div>
